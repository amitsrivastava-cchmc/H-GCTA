...
sim_eff_pheno(direc = dir_name, phen_rep = 100, var_ids = "/data/predataSamit/simulation_with_poe_and_mf_cor/gcta_simulation_pooled_data/pooled_data_comm_variants.txt", nvar = c(nvar1, nvar2, nvar3), var_m = var_m, var_f = var_f);
